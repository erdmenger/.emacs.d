...
;      (append '(("~/lib/info")
;                ("~/lib/info/gnu")) info-directory-list))
...
(cond ((not my-emacs-xemacs-p)
       (autoload 'speedbar-add-supported-extensions 
         "speedbar" "extend supported filetypes" ".txt")))
;; show version control in speedbar
(setq speedbar-vc t)
...
(setq tags-table-list
      '("~/projects/xint-main" "c:/Program Files/Microsoft Visual Studio/VC98/Include"))
...
;;; Worklog-Mode
(autoload 'worklog "c:/home/erde/lib/emacs/lisp/worklog.el"
  "Major mode for editing work logs." t)
...
(cond ((not my-emacs-xemacs-p) (standard-display-8bit 128 254)))
;; am: lpr setzen
;; (setq lpr-switches '("-S 9.164.168.165 -P afccu2"))
;; (setq lpr-command "c:/winnt40/system32/lpr.exe ")
...
(cond (my-emacs-19-p
       ...
       (global-set-key '[C-M-tab] 'my-unbury-buffer)))
